...
}, n = process.argv.splice(2, process.argv.length);
...
let s = t.connect(n[0], n[1]);

s.write("joinGame"), process.openStdin().addListener("data", (function(e) {
    s.write(e.toString().trim() + "\r\n");
}));
